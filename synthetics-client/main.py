...
def cli(
    ...
    # host_add = 'https://localhost:9200'
    # if host and port:
    host_add = {'host': 'localhost', 'port': '9200'}
    client = OpenSearch(
            hosts = [host_add],
            http_compress=True,  # enables gzip compression for request bodies
            http_auth=('admin','admin'),
            # client_cert = '/Users/mohakavi/obs backup/synthetics-client/admin.pem',
            # client_key = '/Users/mohakavi/obs backup/synthetics-client/admin-key-temp.pem',
            use_ssl=False,
            verify_certs=False,
            ssl_assert_hostname=False,
            ssl_show_warn=True,
            ca_certs='/Users/mohakavi/obs backup/synthetics-client/root-ca.pem'
    )
